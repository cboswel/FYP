...
HD_PWD='/home/charlie/FPGA/mcp1/mcp1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pr_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pr_bd_wrapper.tcl -notrace
