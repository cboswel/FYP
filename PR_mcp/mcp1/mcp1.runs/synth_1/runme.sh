...
HD_PWD='/home/charlie/FPGA/mcp1/mcp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pr_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pr_bd_wrapper.tcl
